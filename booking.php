...
<div id="main">
    <div class="container background-white box-shadow">
        <h1 class="page-header">Book Rooms</h1>
		...
		//echo $id;
				...
				if(isset($_POST['submit'])){
				  ...
				  operations::insert_book_table($_POST['fdate'],$_POST['tdate'],$_POST['name'],$_POST['email'],$_POST['mobile'],$_POST['codeword'],$_POST['address'],$_POST['room_no']);
				...
				//include("Model/class_operations_data.php");
					...
					*/
					...
					operations::pending_booking_status($_POST['room_no']);
