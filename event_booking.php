...
<div id="main">
    <div class="container background-white box-shadow">
        <h1 class="page-header">Event Booking</h1>
            ...
            <div class="container">
              ...
              <form method="post" action ="<?php  echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
                    <div class="form-group row">
                        ...
                        <label for="from-date" class="col-sm-3 col-form-label align-right">From</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <label for="to-date" class="col-sm-3 col-form-label align-right">To</label>
                        <div class="col-sm-6">
		...
		//echo $id;
				...
				if(isset($_POST['submit'])){
				  ...
				  operations::insert_event_book_table($_POST['fdate'],$_POST['tdate'],$_POST['name'],$_POST['email'],$_POST['mobile'],$_POST['codeword'],$_POST['address'],$_POST['room_no']);
				...
				//include("Model/class_operations_data.php");
					...
					*/
					...
					operations::pending_event_booking_status($_POST['room_no']);
